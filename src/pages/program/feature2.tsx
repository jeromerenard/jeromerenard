...
const features = [
  ...
  },
  {
    name: 'Guest Sessions',
    description:
      'Bi-Weekly session with guests. I bring a variety of my partners to help you understand the differnet relationship in the industry and get different perspectives.',
    icon: ArrowPathIcon,
  },
  {
    ...
    <div className="bg-white py-24 sm:py-32" id='info'>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Great Sound = Greater Impact</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Everything you need to get better mixes
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
          Everything here is drawn from my personal experience, my work, and insights from my mentors. Mixing has been my career, and this is the culmination of years of dedication and practice.<br />I&apos;m excited to share all this valuable knowledge with you.
          </p>
        </div>
